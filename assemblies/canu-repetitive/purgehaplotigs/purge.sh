...
#minimap2 -I 400G -K 100G -ax map-ont -t 48 ../gvtp_ont_raw_repetitive.contigs.fasta /public/groups/meyerlab/gvtp/ont/raw/ont_all.fastq.gz --secondary=no --split-prefix tmp 1>gvtp_canurepetitive_minimap_ontraw.sam 2>minimap.e
#samtools sort -@48 -m 1G -o gvtp_canurepetitive_minimap_ontraw.bam -T tmp.ali gvtp_canurepetitive_minimap_ontraw.sam 1>sort.o 2>sort.e

#purge_haplotigs hist -b gvtp_canurepetitive_minimap_ontraw.bam -g ../gvtp_ont_raw_repetitive.contigs.fasta -t 48 1>purgehap1.o 2> purgehap1.e
#purge_haplotigs  cov  -i gvtp_canurepetitive_minimap_ontraw.bam.gencov -l 0 -m 100 -h 195 1>purgehap2.o 2>purgehap2.e
#purge_haplotigs purge -g ../gvtp_ont_raw_repetitive.contigs.fasta -c coverage_stats.csv -t 48 1> purgehap3.o 2>purgehap3.e
purge_haplotigs purge -g ../gvtp_ont_raw_repetitive.contigs.fasta -c coverage_stats.csv -r canurep_assembly_repeats.bed -t 48 1> purgehap4.o 2>purgehap4.e
