...
verkko --local-memory 450 --local-cpus 48 --mashmap /public/groups/meyerlab/software/mashmap-Linux64-v2.0/mashmap -d /public/groups/meyerlab/gvtp/assemblies/verkko10k --hifi ../../filteredhifi/gvtp_hifi_adapterfilt_all.fastq.gz --nano ../../ont/10kb/ont_all_10kfilt.fastq 1>verkko.o 2>verkko.e
