...
#mkdir tmp
#ls ../../filteredhifi/gvtp_all_hifi.fastq.gz ../../ont/raw/ont_all.fastq.gz > FILES
# kmer 21, 16 threads, 64G of memory, counting kmer coverages between 1 and 10000x

#/public/groups/meyerlab/software/kmc/bin/kmc -k27 -t32 -m80 -ci1 -cs500000 @FILES gvtp_kmcdb tmp
#/public/groups/meyerlab/software/kmc/bin/kmc_tools transform gvtp_kmcdb histogram gvtp_hifi_ont_kmcdb_k27.hist -cx500000

L=$(smudgeplot.py cutoff gvtp_hifi_ont_kmcdb_k27.hist L)
U=$(smudgeplot.py cutoff gvtp_hifi_ont_kmcdb_k27.hist U)
